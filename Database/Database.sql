...
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 82 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
(
    ...
    cv_candidate_id integer NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE public.social_media_link_type
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    workplaces_name character varying(100) NOT NULL,
    PRIMARY KEY (id)
);
...
ALTER TABLE public.language_candidates
    ADD FOREIGN KEY (cv_candidate_id)
    REFERENCES public.candidates (id)
    NOT VALID;
...
ALTER TABLE public.social_medias
    ...
    REFERENCES public.social_media_link_type (id)
    NOT VALID;
