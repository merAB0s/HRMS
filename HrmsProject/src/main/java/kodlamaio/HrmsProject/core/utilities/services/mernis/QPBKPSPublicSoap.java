...
public class QPBKPSPublicSoap
{
    ...
    public QPBKPSPublicSoap(){}

    public QPBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QPBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QPBExtendedSoapSerializationEnvelope envelope= new QPBExtendedSoapSerializationEnvelope(QPBExtendedSoapSerializationEnvelope.VER11);
