...
public class QPBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QPBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QPBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QPBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QPBDateTimeConverter dateTimeConverter = new QPBStandardDateTimeConverter();

    public QPBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QPBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QPBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName= QPBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QPBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QPBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
