package kodlamaio.HrmsProject.core.utilities.services.mernis;
...
import kodlamaio.HrmsProject.core.utilities.services.mernis.QPBExtendedSoapSerializationEnvelope;
...
public class QPBKPSPublicSoap12
{
    interface QPBIWcfMethod
    {
        QPBExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(QPBExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public QPBKPSPublicSoap12(){}

    public QPBKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public QPBKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected QPBExtendedSoapSerializationEnvelope createEnvelope()
    {
        QPBExtendedSoapSerializationEnvelope envelope= new QPBExtendedSoapSerializationEnvelope(QPBExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,QPBExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,QPBExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new QPBIWcfMethod()
        {
            @Override
            public QPBExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                QPBExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(QPBExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(QPBIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        QPBExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,QPBExtendedSoapSerializationEnvelope envelope)
    {
